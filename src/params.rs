...
pub const DEFAULT_SINGLE_FILE: &str = "players";
...
pub struct Params {
    ...
    pub single_file: bool,              // write one file per team vs merged single
    pub format: Delim,
}
...
impl Params {
    pub fn new() -> Self {
        Self {
            ...
            all: true,
            one_team: None,
            out: Some(PathBuf::from(DEFAULT_OUT_DIR).join(PLAYERS_SUBDIR)),
            keep_hash: false,
